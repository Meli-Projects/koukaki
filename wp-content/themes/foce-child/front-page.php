    ...
    <main id="primary" class="site-main">
        ...
        <section id="story" class="story fadeUp">
            ...
            <article id="place">
                ...
                <img src="<?php echo get_stylesheet_directory_uri() . "/assets/images/big_cloud.png";?>" alt="image d'un gros nuage" class="big_cloud">
                <img src="<?php echo get_stylesheet_directory_uri() . "/assets/images/little_cloud.png";?>" alt="image d'un petit nuage" class="little_cloud">
